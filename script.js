...
const totalScores = { computerScores: 0, playerScore: 0 }
...
function playGame() {
  ...
  // * Adds an on click event listener to each RPS button an d every time you click it, it calls the onClickRPS function with the RPS button that was last clicked 
